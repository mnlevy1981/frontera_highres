...
RES=TL319_t13
USER_STREAM_DIR=${SCRIPT_DIR}/user_streams_derecho
SOURCEMOD_DIR=${SCRIPT_DIR}/SourceMods
ref_dir=/glade/campaign/cgd/oce/projects/FOSI_BGC/HR/g.e22.TL319_t13.G1850ECOIAF_JRA_HR.4p2z.001
ref_case=g.e22.TL319_t13.G1850ECOIAF_JRA_HR.4p2z.001
ref_date=2004-01-01
...
./create_newcase --project ${PROJECT} --compset ${COMPSET} --res ${RES} --case ${CASEROOT_PARENT}/${CASENAME} --run-unsupported
...
./xmlchange RUN_TYPE=branch,RUN_REFCASE=${ref_case},RUN_REFDATE=${ref_date}
./xmlchange RUN_STARTDATE=${ref_date}
...
ndep_shr_stream_file = '/glade/campaign/cesm/cesmdata/inputdata/ocn/pop/tx0.1v3/forcing/ocn_Ndep_transient_forcing_x0.1_241004.nc'
ndep_shr_stream_scale_factor = 7.1429e+06
ndep_shr_stream_year_align = 1958
ndep_shr_stream_year_first = 1958
ndep_shr_stream_year_last = 2023
...
cat >> user_nl_datm << EOF
  streams = "datm.streams.txt.CORE_IAF_JRA.GCGCS.PREC 1958 1958 2023",
      "datm.streams.txt.CORE_IAF_JRA.GISS.LWDN 1958 1958 2023",
      "datm.streams.txt.CORE_IAF_JRA.GISS.SWDN 1958 1958 2023",
      "datm.streams.txt.CORE_IAF_JRA.NCEP.Q_10 1958 1958 2023",
      "datm.streams.txt.CORE_IAF_JRA.NCEP.SLP_ 1958 1958 2023",
      "datm.streams.txt.CORE_IAF_JRA.NCEP.T_10 1958 1958 2023",
...
cat >> user_nl_drof << EOF
  streams = "drof.streams.txt.rof.iaf_jra 1958 1958 2023"
EOF
...
echo "cd to that directory and run 'qcmd -- ./case.build'"
